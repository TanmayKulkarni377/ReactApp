...
const Billing = () =>  (
   <section id='product' className={layout.sectionReverse} >
    ...
    <div className='absolute z-[3]top-0 w-[50%] -left-1/2
    h-[50%] rounded-full white__gradient  ' />
    <div className='absolute z-[0]top-0 w-[50%] -left-1/2
    ...
    <div className={layout.sectionInfo}>
      ...
      <img src={apple} alt='app-store'
       className='w-[128px] h-[42px] object-contain m-5 cursor-pointer ' />
